...
from manage_customer_account import ManageCustomerAccount  # Import the customer management module
...
def open_manage_customers():
    """Open the Manage Customer Account Window."""
    manage_customers_root = tk.Toplevel(root)
    ManageCustomerAccount(manage_customers_root)
...
create_card(card_container, 1, 2, "Manage Customers", "Staff Manages Customer Account.", open_manage_customers)
